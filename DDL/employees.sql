...
DECLARE
    ...
    v_null_constraint_violation EXCEPTION;
    PRAGMA EXCEPTION_INIT(v_null_constraint_violation, -1400); -- Null constraint violation error code
...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN v_null_constraint_violation THEN
            DBMS_OUTPUT.PUT_LINE('First name / Role cannot be null. Skipping insertion.');
        WHEN OTHERS THEN
    ...
    BEGIN
        INSERT INTO EMPLOYEES (employee_id, fname, lname, street, city, state, zip, country, salary, gender, ssn, start_date, end_date, role)
        VALUES (120, 'John', 'Kenedy', '4156 Warren St', 'Watertown', 'Massachusetts', '07102', 'USA', 40000.00, 'M', '907-65-4171', TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL, 'Kitchen_crew');
